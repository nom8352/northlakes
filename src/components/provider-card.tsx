...
export function ProviderCard({ provider }: { provider: ActivityProvider }) {
  return (
    <article className="overflow-hidden rounded-[2rem] border border-sky-100 bg-white shadow-[0_18px_60px_rgba(22,32,51,0.06)] transition hover:-translate-y-1 hover:shadow-[0_26px_70px_rgba(47,95,183,0.10)]">
      <div
      ...
      <div className="p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            ...
            target="_blank"
            className="inline-flex items-center gap-2 rounded-full bg-[linear-gradient(135deg,#2f5fb7_0%,#1a3563_100%)] px-4 py-2 text-sm font-bold text-white transition hover:brightness-110"
          >
